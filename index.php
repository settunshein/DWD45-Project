    ...
    <div id="carouselExampleCaptions" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/common/img_slider_1.jpg" class="d-block w-100 carousel-img"
            ...
            <div class="carousel-item">
                <img src="assets/img/common/img_slider_2.jpg" class="d-block w-100 carousel-img"
                style="filter: brightness(42%);">
                <div class="carousel-caption d-none d-md-block px-5">
            ...
            <div class="carousel-item">
                <img src="assets/img/common/img_slider_3.jpg" class="d-block w-100 carousel-img"
                style="filter: brightness(42%);">
                <div class="carousel-caption d-none d-md-block px-5">
                    <h2 class="fs-1 fw-900 mb-4">LOREM IPSUM</h2>
                    <p class="px-5 custom-lh">
...
<section class="sec-services py-5">
    <div class="container px-0 py-0 py-md-5">
        <div class="row">
            <div class="heading-bx mb-4">
                <h2 class="fw-bold text-uppercase">
                    <small class="fs-6">Our Services</small>
                    <span class="fs-4 d-block">What We Offer?</span>
                </h2>
            </div>

            <div class="service-blk">
                <div class="row">
                    <div class="col-lg-4 service-bx mb-4">
