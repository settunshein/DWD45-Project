<form style="display: inline;" method="POST">
    <input type="hidden" value="<?=$brand['id']?>" name="del_brand_id">
    <div class="container">
        <div class="row">
            <div class="modal fade" tabindex="-1" role="dialog" id="showDeleteBrandModal<?=$brand['id']?>">
                <div class="modal-dialog modal-dialog-centered" role="document">

                    <div class="modal-content">
                        <div class="modal-header align-items-center">
                            <span class="custom-card-title">Delete Brand Form</span>
