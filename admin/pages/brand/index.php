<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
    ...
    <div class="card mb-5">
        <div class="card-header d-flex justify-content-between align-items-center">
            <span class="table-title">Brand List Table</span>
                ...
                <tbody>
                    <?php if(mysqli_num_rows($brands) > 0): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="dashboard.php?view=brand_edit&edit_brand_id=<?=$brand['id']?>"
                                class="btn-sm btn btn-outline-dark rounded-0">
                                    <i class="fa fa-edit"></i>
                                </a>

                                <a href="javascript:;" class="btn btn-sm btn-outline-dark rounded-0"
                                data-toggle="modal" data-target="#showDeleteBrandModal<?=$brand['id']?>">
        ...
        <?php $total_page = get_paginator('tbl_brands', 5); ?>
        <?php if( $total_page > 1 ): ?>
            ...
            <nav>
                <ul class="pagination justify-content-end mb-0 fs-13">
                    ...
                    <li class="page-item <?= $active ?>">
                        <a class="page-link" href="dashboard.php?view=brand_index&page=<?= $i ?>"><?= $i ?></a>
                    </li>
                    <?php endfor; ?>
