            ...
            <div class="col-md-8 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="table-title py-1">Edit Car Form</span>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="engine" id="engine" class="form-control" value="<?= $car['engine'] ?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="model_year" id="model_year" class="form-control" value="<?= $car['model_year'] ?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="capacity" id="capacity" class="form-control" min="2" value="<?= $car['capacity'] ?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="transmission" id="transmission" class="form-control" required>
                                    ...
                                    <option value="both" <?= $car['transmission']=='both' ? 'selected' : '' ?>>
                                        Manual & Automatic
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="plate_no" id="plate_no" class="form-control" value="<?= $car['plate_no'] ?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="fuel_type" id="fuel_type" class="form-control" value="<?= $car['fuel_type'] ?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="rent_fee" id="rent_fee" class="form-control" value="<?= $car['rent_fee'] ?>" required>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="status" id="status" class="form-control" required>
                                    ...
                                    <option value="0" <?= $car['status'] == 0 ? 'selected' : '' ?>>Unavailable</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12 mb-0">
                                <input type="file" class="dropify" name="car_img" id="car_img"
                                data-default-file =
                                <?php
                                    if (isset($car['image'])) {
                                        echo "_uploads/cars/{$car['image']}";
                                    }
                                ?>>
                            </div>
                        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                        ...
                        <div class="form-row justify-content-between">
                            <div class="col-3 mb-4 mb-md-0 px-0">
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['air_condition']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['child_seats']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['luggage']) ?>>
                            ...
                            <div class="col-3 mb-4 mb-md-0 px-0">
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['seat_belt']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['sleeping_bed']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['music_player']) ?>>
                            ...
                            <div class="col-3 mb-4 mb-md-0 px-0">
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['bluetooth']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['onboard_computer']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['audio_input']) ?>>
                                ...
                                <div class="form-check mb-3">
                                    ...
                                    <?= is_checked_feature($car['car_kit']) ?>>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-sm btn-outline-dark rounded-0 float-right" type="submit" name="edit_car">
